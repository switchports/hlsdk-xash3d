...
void CMedic :: Spawn()
{
	...
	m_flHealAnount		= gSkillData.medicAllyHeal;
...
void CMedic::FollowerUse( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
...
void CMedicRepel::RepelUse ( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	pBeam->SetThink( &CMedicRepel::SUB_Remove );
